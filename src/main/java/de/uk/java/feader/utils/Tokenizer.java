 ...
 * Alle ben√∂tigten Methoden wurden innerhalb der Klasse definiert.
 *
 */
public class Tokenizer implements ITokenizer{
	 ...
	 * 
	 * Der String "token" bewahrt das n√§chste Wort des Tokenizers auf.
	 ...
	 * Im letzten Schritt wird ueberpr√ºft, ob der String leer ist.
	...
	public List<String> tokenize(String text) {
		...
		while (st.hasMoreTokens()) {
			...
			token = token.replaceAll("[^ˆ÷‰ƒ¸‹ﬂa-zA-Z]","");
